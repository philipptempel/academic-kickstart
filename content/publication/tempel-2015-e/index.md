...
title: Modelling of Kinematics and Dynamics of the IPAnema 3 Cable Robot for Simulative
  Analysis
subtitle: ''
summary: ''
authors:
...
abstract: This paper covers the kinematics and dynamics modelling ofthe mechatronic
  ...
  presented. Given the real-time capability, the presented model can be used for hardware-in-the-loop
  simulation or controller design, but also for case studies of highly dynamic or
  large-scale robots.

...
title: 'Estimating Inertial Parameters of Suspended Cable-Driven Parallel Robots:
  Use Case on CoGiRo'
subtitle: ''
summary: ''
authors:
...
abstract: Model based open-loop and closed-loop control systems make use of the system's
  ...
  yet in very few cases to cable-driven parallel robots. Due to their kinematic properties
  and their unique setup, cable robots are more sensitive to incorrect estimates of

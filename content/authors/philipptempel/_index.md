...
education:
  courses:
  - course: Doctor of Engineering (Dr.-Ing.) Parallel Robotics
    institution: University of Stuttgart
    year: 2019
  - course: Graduate Engineer (Dipl.-Ing.) Engineering Cybernetics
    institution: University of Stuttgart
    year: 2012
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:p.tempel@tudelft.nl'  # For a direct email link, use "mailto:test@example.org".
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=lB9CAbQAAAAJ
- icon: researchgate
  icon_pack: ai
  link: https://researchgate.net/profile/Philipp_Tempel
- icon: orcid
  icon_pack: ai
...
- icon: academia
  icon_pack: ai
  link: https://uni-stuttgart.academia.edu/PhilippTempel
- icon: github
  icon_pack: fab
  link: https://github.com/philipptempel
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/phlpptmpl
- icon: instagram
  icon_pack: fab
